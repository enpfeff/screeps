...
const HARVESTER = CONSTANTS.TYPE.HARVESTER;
...
function create(sourcesById) {
    // if theres a spot open we need a harvester
...
function spawnHarvester(assignmentId) {
    ...
    const creep = spawnService.createCreep(HARVESTER_BODY, id, {
        role: HARVESTER,
        id: id,
    ...
    return spawnService.createTask(CONSTANTS.PRIORITY.MIDDLE, creep);
}
